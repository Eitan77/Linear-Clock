...
6/25 - Created concept design for clock shell

6/26 - started modeling the enclosure in Onshape 

6/27 - Continued with model and looked into electronics 

6/28 - Finished enclosure design and began working on PCB

6/29 - Continued with PCB desgin 

6/30 - Finished PCB design, refining enclosure design 

7/1, I am working on a PCB mounting bracket. I am trying to make the PCB as small as possible to save on production costs, so instead of making a PCB that takes up the whole face of the clock, I am making it smaller and then holding it in place with a 3D printed bracket. I might split it in half later and have 2 separate PCBs to save on shipping costs. 

Since 7/1, waiting for approval and looking into how I can most efficiently print it 
